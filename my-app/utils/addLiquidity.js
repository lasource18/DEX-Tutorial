 ...
 * given `_addEtherAmountWui` amount of ether
 */
export const calculateCD = async (
    ...
    const _addEtherAmountWui = utils.parseEther(_addEther)

    // Ratio neds to  be maintained when we add liquidity.
    // We need to let the user know for a specific amount of ETH how many `CD` tokens
    ...
    const cryptoDevTokenAmount = _addEtherAmountWui
    .mul(cdTokenReserve)
